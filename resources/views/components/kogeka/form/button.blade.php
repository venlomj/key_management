...
@php
    ...
    $options = [
        'dark' => 'bg-tertiary-500 hover:bg-primary-500 active:bg-tertiary-500 focus:border-gray-900 focus:ring-gray-300',
        ...
        'info' => 'bg-secondary-500 hover:bg-sky-700 active:bg-secondary-500 focus:border-sky-900 focus:ring-sky-300',
    ];
