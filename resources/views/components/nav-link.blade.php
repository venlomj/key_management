...
@php
    $classes = ($active ?? false)
                ...
                : 'group inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-500 border-b-0 hover:text-gray-700 hover:border-transparent focus:outline-none focus:text-gray-700 focus:border-transparent transition duration-150 ease-in-out';
@endphp
